    ...
    public void OnPanUpdated(object sender, PanUpdatedEventArgs e)
    {
        ...
        switch (e.StatusType)
        {
            case GestureStatus.Running:
                ...
                double minX = (width - (Width / 2)) * -1;
                double maxX = Math.Min(Width / 2, width / 2);
                ...
                double minY = (height - (Height / 2)) * -1;
                double maxY = Math.Min(Height / 2, height / 2);
                ...
                Content.TranslationY = newY; break;
