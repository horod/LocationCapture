...
{
    public class CameraRotationHelper : ICameraRotationHelper
    {
        ...
        public bool IsEnclosureLocationExternal(EnclosureLocation enclosureLocation)
        {
        ...
        public SimpleOrientation GetUIOrientation()
        {
            ...
            var deviceOrientation = (_orientationSensor != null) ? _orientationSensor.GetCurrentOrientation() : SimpleOrientation.NotRotated;
        ...
        public PhotoOrientation ConvertSimpleOrientationToPhotoOrientation(SimpleOrientation orientation)
        {
            switch (orientation)
            {
        ...
        public int ConvertSimpleOrientationToClockwiseDegrees(SimpleOrientation orientation)
        {
            switch (orientation)
            {
                case SimpleOrientation.Rotated90DegreesCounterclockwise:
        ...
        public SimpleOrientation MirrorOrientation(SimpleOrientation orientation)
        {
        ...
        private SimpleOrientation AddOrientations(SimpleOrientation a, SimpleOrientation b)
        {
        ...
        private SimpleOrientation SubOrientations(SimpleOrientation a, SimpleOrientation b)
        {
            var aRot = ConvertSimpleOrientationToClockwiseDegrees(a);
            var bRot = ConvertSimpleOrientationToClockwiseDegrees(b);
        ...
        private VideoRotation ConvertSimpleOrientationToVideoRotation(SimpleOrientation orientation)
        {
            switch (orientation)
            {
                case SimpleOrientation.Rotated90DegreesCounterclockwise:
        ...
        private SimpleOrientation ConvertClockwiseDegreesToSimpleOrientation(int orientation)
        {
            switch (orientation)
            {
                case 270:
